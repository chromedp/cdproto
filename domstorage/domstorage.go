...
func (p *ClearParams) Do(ctxt context.Context, h Executor) (err error) {
...
// returns:
//   entries
func (p *GetDOMStorageItemsParams) Do(ctxt context.Context, h Executor) (entries []Item, err error) {
	// execute
...
func (p *RemoveDOMStorageItemParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetDOMStorageItemParams) Do(ctxt context.Context, h Executor) (err error) {
