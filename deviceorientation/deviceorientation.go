...
func (p *ClearDeviceOrientationOverrideParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetDeviceOrientationOverrideParams) Do(ctxt context.Context, h Executor) (err error) {
