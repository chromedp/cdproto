...
func (p *EndParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *GetCategoriesParams) Do(ctxt context.Context, h Executor) (categories []string, err error) {
	// execute
...
func (p *RecordClockSyncMarkerParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *RequestMemoryDumpParams) Do(ctxt context.Context, h Executor) (dumpGUID string, success bool, err error) {
	// execute
