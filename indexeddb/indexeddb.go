...
func (p *ClearObjectStoreParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *DeleteDatabaseParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *DeleteObjectStoreEntriesParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *RequestDataParams) Do(ctxt context.Context, h Executor) (objectStoreDataEntries []*DataEntry, hasMore bool, err error) {
	// execute
...
func (p *RequestDatabaseParams) Do(ctxt context.Context, h Executor) (databaseWithObjectStores *DatabaseWithObjectStores, err error) {
	// execute
...
func (p *RequestDatabaseNamesParams) Do(ctxt context.Context, h Executor) (databaseNames []string, err error) {
	// execute
