...
func (p *GetCurrentTimeParams) Do(ctxt context.Context, h Executor) (currentTime float64, err error) {
	// execute
...
func (p *GetPlaybackRateParams) Do(ctxt context.Context, h Executor) (playbackRate float64, err error) {
	// execute
...
func (p *ReleaseAnimationsParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *ResolveAnimationParams) Do(ctxt context.Context, h Executor) (remoteObject *runtime.RemoteObject, err error) {
	// execute
...
func (p *SeekAnimationsParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetPausedParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetPlaybackRateParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetTimingParams) Do(ctxt context.Context, h Executor) (err error) {
