...
func (p *ActivateTargetParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *AttachToTargetParams) Do(ctxt context.Context, h Executor) (sessionID SessionID, err error) {
	// execute
...
// returns:
//   success
func (p *CloseTargetParams) Do(ctxt context.Context, h Executor) (success bool, err error) {
	// execute
...
func (p *CreateBrowserContextParams) Do(ctxt context.Context, h Executor) (browserContextID BrowserContextID, err error) {
	// execute
...
func (p *CreateTargetParams) Do(ctxt context.Context, h Executor) (targetID ID, err error) {
	// execute
...
func (p *DetachFromTargetParams) Do(ctxt context.Context, h Executor) (err error) {
...
// returns:
//   success
func (p *DisposeBrowserContextParams) Do(ctxt context.Context, h Executor) (success bool, err error) {
	// execute
...
// returns:
//   targetInfo
func (p *GetTargetInfoParams) Do(ctxt context.Context, h Executor) (targetInfo *Info, err error) {
	// execute
...
func (p *GetTargetsParams) Do(ctxt context.Context, h Executor) (targetInfos []*Info, err error) {
	// execute
...
func (p *SendMessageToTargetParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetAttachToFramesParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetAutoAttachParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetDiscoverTargetsParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetRemoteLocationsParams) Do(ctxt context.Context, h Executor) (err error) {
