...
//   nodes
//   jsEventListeners
func (p *GetDOMCountersParams) Do(ctxt context.Context, h Executor) (documents int64, nodes int64, jsEventListeners int64, err error) {
	// execute
...
func (p *PrepareForLeakDetectionParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetPressureNotificationsSuppressedParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SimulatePressureNotificationParams) Do(ctxt context.Context, h Executor) (err error) {
