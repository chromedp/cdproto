...
func (p *ClearDataForOriginParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *GetUsageAndQuotaParams) Do(ctxt context.Context, h Executor) (usage float64, quota float64, usageBreakdown []*UsageForType, err error) {
	// execute
...
func (p *TrackCacheStorageForOriginParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *TrackIndexedDBForOriginParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *UntrackCacheStorageForOriginParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *UntrackIndexedDBForOriginParams) Do(ctxt context.Context, h Executor) (err error) {
