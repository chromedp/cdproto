...
func (p *DeliverPushMessageParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *DispatchSyncEventParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *InspectWorkerParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetForceUpdateOnPageLoadParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SkipWaitingParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StartWorkerParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StopAllWorkersParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StopWorkerParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *UnregisterParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *UpdateRegistrationParams) Do(ctxt context.Context, h Executor) (err error) {
