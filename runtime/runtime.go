...
func (p *AwaitPromiseParams) Do(ctxt context.Context, h Executor) (result *RemoteObject, exceptionDetails *ExceptionDetails, err error) {
	// execute
...
func (p *CallFunctionOnParams) Do(ctxt context.Context, h Executor) (result *RemoteObject, exceptionDetails *ExceptionDetails, err error) {
	// execute
...
//   exceptionDetails - Exception details.
func (p *CompileScriptParams) Do(ctxt context.Context, h Executor) (scriptID ScriptID, exceptionDetails *ExceptionDetails, err error) {
	// execute
...
func (p *DiscardConsoleEntriesParams) Do(ctxt context.Context, h Executor) (err error) {
...
//   exceptionDetails - Exception details.
func (p *EvaluateParams) Do(ctxt context.Context, h Executor) (result *RemoteObject, exceptionDetails *ExceptionDetails, err error) {
	// execute
...
//   exceptionDetails - Exception details.
func (p *GetPropertiesParams) Do(ctxt context.Context, h Executor) (result []*PropertyDescriptor, internalProperties []*InternalPropertyDescriptor, exceptionDetails *ExceptionDetails, err error) {
	// execute
...
// returns:
//   names
func (p *GlobalLexicalScopeNamesParams) Do(ctxt context.Context, h Executor) (names []string, err error) {
	// execute
...
func (p *QueryObjectsParams) Do(ctxt context.Context, h Executor) (objects *RemoteObject, err error) {
	// execute
...
func (p *ReleaseObjectParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *ReleaseObjectGroupParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *RunIfWaitingForDebuggerParams) Do(ctxt context.Context, h Executor) (err error) {
...
//   result - Run result.
//   exceptionDetails - Exception details.
func (p *RunScriptParams) Do(ctxt context.Context, h Executor) (result *RemoteObject, exceptionDetails *ExceptionDetails, err error) {
	// execute
...
func (p *SetCustomObjectFormatterEnabledParams) Do(ctxt context.Context, h Executor) (err error) {
