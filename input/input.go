...
func (p *DispatchKeyEventParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *DispatchMouseEventParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *DispatchTouchEventParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *EmulateTouchFromMouseEventParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SetIgnoreInputEventsParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SynthesizePinchGestureParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SynthesizeScrollGestureParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *SynthesizeTapGestureParams) Do(ctxt context.Context, h Executor) (err error) {
