	...
	for !in.IsDelim('}') {
		...
		case "signatures":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v11 *SignedExchangeSignature
					if in.IsNull() {
						in.Skip()
						v11 = nil
					} else {
						if v11 == nil {
							v11 = new(SignedExchangeSignature)
						}
						(*v11).UnmarshalEasyJSON(in)
					}
					out.Signatures = append(out.Signatures, v11)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoNetwork7(out *jwriter.Writer, in SignedExchangeHeader) {
	...
	}
	{
		...
		if in.ResponseHeaders == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v12First := true
			for v12Name, v12Value := range in.ResponseHeaders {
				if v12First {
					v12First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Signatures == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v13, v14 := range in.Signatures {
				if v13 > 0 {
					out.RawByte(',')
				}
				if v14 == nil {
...
func easyjsonC5a4559bDecodeGithubComChromedpCdprotoNetwork8(in *jlexer.Lexer, out *SignedCertificateTimestamp) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoNetwork8(out *jwriter.Writer, in SignedCertificateTimestamp) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonC5a4559bDecodeGithubComChromedpCdprotoNetwork9(in *jlexer.Lexer, out *SetUserAgentOverrideParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoNetwork9(out *jwriter.Writer, in SetUserAgentOverrideParams) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "patterns":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v15 *RequestPattern
					if in.IsNull() {
						in.Skip()
						v15 = nil
					} else {
						if v15 == nil {
							v15 = new(RequestPattern)
						}
						(*v15).UnmarshalEasyJSON(in)
					}
					out.Patterns = append(out.Patterns, v15)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoNetwork52(out *jwriter.Writer, in EventRequestIntercepted) {
	...
	if len(in.ResponseHeaders) != 0 {
		...
		}
		{
			out.RawByte('{')
			v54First := true
			for v54Name, v54Value := range in.ResponseHeaders {
				if v54First {
					v54First = false
				} else {
					out.RawByte(',')
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoNetwork63(out *jwriter.Writer, in ContinueInterceptedRequestParams) {
	...
	if len(in.Headers) != 0 {
		...
		}
		{
			out.RawByte('{')
			v56First := true
			for v56Name, v56Value := range in.Headers {
				if v56First {
					v56First = false
				} else {
					out.RawByte(',')
