...
type BeginFrameReturns struct {
	HasDamage      bool   `json:"hasDamage,omitempty,omitzero"`      // Whether the BeginFrame resulted in damage and, thus, a new frame was committed to the display. Reported for diagnostic uses, may be removed in the future.
