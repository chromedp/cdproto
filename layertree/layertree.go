...
func (p *CompositingReasonsParams) Do(ctxt context.Context, h Executor) (compositingReasons []string, err error) {
	// execute
...
func (p *LoadSnapshotParams) Do(ctxt context.Context, h Executor) (snapshotID SnapshotID, err error) {
	// execute
...
func (p *MakeSnapshotParams) Do(ctxt context.Context, h Executor) (snapshotID SnapshotID, err error) {
	// execute
...
func (p *ProfileSnapshotParams) Do(ctxt context.Context, h Executor) (timings []PaintProfile, err error) {
	// execute
...
func (p *ReleaseSnapshotParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *ReplaySnapshotParams) Do(ctxt context.Context, h Executor) (dataURL string, err error) {
	// execute
...
func (p *SnapshotCommandLogParams) Do(ctxt context.Context, h Executor) (commandLog []easyjson.RawMessage, err error) {
	// execute
