...
//   values
//   sqlError
func (p *ExecuteSQLParams) Do(ctxt context.Context, h Executor) (columnNames []string, values []easyjson.RawMessage, sqlError *Error, err error) {
	// execute
...
// returns:
//   tableNames
func (p *GetDatabaseTableNamesParams) Do(ctxt context.Context, h Executor) (tableNames []string, err error) {
	// execute
