...
func (p *AddInspectedHeapObjectParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *CollectGarbageParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *GetHeapObjectIDParams) Do(ctxt context.Context, h Executor) (heapSnapshotObjectID HeapSnapshotObjectID, err error) {
	// execute
...
func (p *GetObjectByHeapObjectIDParams) Do(ctxt context.Context, h Executor) (result *runtime.RemoteObject, err error) {
	// execute
...
func (p *GetSamplingProfileParams) Do(ctxt context.Context, h Executor) (profile *SamplingHeapProfile, err error) {
	// execute
...
func (p *StartSamplingParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StartTrackingHeapObjectsParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StopSamplingParams) Do(ctxt context.Context, h Executor) (profile *SamplingHeapProfile, err error) {
	// execute
...
func (p *StopTrackingHeapObjectsParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *TakeHeapSnapshotParams) Do(ctxt context.Context, h Executor) (err error) {
