...
func (p *DeleteCacheParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *DeleteEntryParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *RequestCacheNamesParams) Do(ctxt context.Context, h Executor) (caches []*Cache, err error) {
	// execute
...
func (p *RequestCachedResponseParams) Do(ctxt context.Context, h Executor) (response *CachedResponse, err error) {
	// execute
...
func (p *RequestEntriesParams) Do(ctxt context.Context, h Executor) (cacheDataEntries []*DataEntry, hasMore bool, err error) {
	// execute
