...
func (p *ReadParams) Do(ctxt context.Context, h Executor) (data string, eof bool, err error) {
	// execute
	var res ReadReturns
...
func (p *ResolveBlobParams) Do(ctxt context.Context, h Executor) (uuid string, err error) {
	// execute
