...
func (p *StartViolationsReportParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StopViolationsReportParams) Do(ctxt context.Context, h Executor) (err error) {
