...
func (p *GetBestEffortCoverageParams) Do(ctxt context.Context, h Executor) (result []*ScriptCoverage, err error) {
	// execute
...
func (p *SetSamplingIntervalParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StartParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StartPreciseCoverageParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StartTypeProfileParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StopParams) Do(ctxt context.Context, h Executor) (profile *Profile, err error) {
	// execute
	var res StopReturns
...
func (p *StopPreciseCoverageParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *StopTypeProfileParams) Do(ctxt context.Context, h Executor) (err error) {
...
// returns:
//   result - Coverage data for the current isolate.
func (p *TakePreciseCoverageParams) Do(ctxt context.Context, h Executor) (result []*ScriptCoverage, err error) {
	// execute
...
func (p *TakeTypeProfileParams) Do(ctxt context.Context, h Executor) (result []*ScriptTypeProfile, err error) {
	// execute
