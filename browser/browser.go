...
func (p *CloseParams) Do(ctxt context.Context, h Executor) (err error) {
...
func (p *GetVersionParams) Do(ctxt context.Context, h Executor) (protocolVersion string, product string, revision string, userAgent string, jsVersion string, err error) {
	// execute
...
func (p *GetWindowBoundsParams) Do(ctxt context.Context, h Executor) (bounds *Bounds, err error) {
	// execute
...
//   windowID - Browser window id.
//   bounds - Bounds information of the window. When window state is 'minimized', the restored window position and size are returned.
func (p *GetWindowForTargetParams) Do(ctxt context.Context, h Executor) (windowID WindowID, bounds *Bounds, err error) {
	// execute
...
func (p *SetWindowBoundsParams) Do(ctxt context.Context, h Executor) (err error) {
